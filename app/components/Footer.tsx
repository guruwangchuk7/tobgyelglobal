        ...
        <div className="lg:hidden space-y-8 pb-10 border-b border-slate-800/80 text-left max-w-xl mx-auto">
          ...
          <div className="space-y-6 pt-4 border-t border-slate-800/60">
            ...
            <div className="space-y-1">
              ...
              <div className="text-xs sm:text-sm text-slate-300 font-normal leading-relaxed space-y-0.5">
                ...
                {contact.socialLinks?.facebook && (
                  <a href={contact.socialLinks.facebook} target="_blank" rel="noopener noreferrer" className="hover:text-[#EAA500] block py-0.5 break-all">
            ...
            <div className="flex items-center space-x-5 pt-2 text-slate-300">
              {contact.socialLinks?.facebook && (
                <a href={contact.socialLinks.facebook} target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="hover:text-[#EAA500] transition-colors p-1">
              ...
              <a href={`https://${contact.websiteUrl || "www.tobgyelglobalxpos.com"}`} target="_blank" rel="noopener noreferrer" aria-label="Website" className="hover:text-[#EAA500] transition-colors p-1">
              ...
              <div className="space-y-3 pt-1 text-sm font-semibold">
                ...
                {contact.socialLinks?.facebook && (
                  <div className="flex items-center gap-3">
                    ...
                    <a href={contact.socialLinks.facebook} target="_blank" rel="noopener noreferrer" className="hover:text-[#EAA500] transition-colors py-1 break-all">
                      facebook.com/tobgyelevnts.bhutan
                    </a>
                  </div>
                )}
        ...
        {showQuickLinks && (
          <div className="mt-3 pt-3 border-t border-slate-800/60 transition-all">
            <div className="flex flex-wrap items-center justify-center sm:justify-end gap-2.5 font-semibold text-xs text-slate-200">
              ...
              >
                <span className="text-[#EAA500]">•</span> Import &amp; Export (DRC)
              </a>
              <a
                ...
                className="hover:text-[#EAA500] transition-colors inline-flex items-center gap-2 bg-slate-900/80 px-3.5 py-1.5 rounded-md border border-slate-700/80 hover:border-[#EAA500]/50"
              >
                <span className="text-[#EAA500]">•</span> Immigration / Visa &amp; Permit
              </a>
              <a
                ...
                className="hover:text-[#EAA500] transition-colors inline-flex items-center gap-2 bg-slate-900/80 px-3.5 py-1.5 rounded-md border border-slate-700/80 hover:border-[#EAA500]/50"
              >
                <span className="text-[#EAA500]">•</span> SDF Information
              </a>
              <a
                ...
                className="hover:text-[#EAA500] transition-colors inline-flex items-center gap-2 bg-slate-900/80 px-3.5 py-1.5 rounded-md border border-slate-700/80 hover:border-[#EAA500]/50"
              >
                <span className="text-[#EAA500]">•</span> Department of Tourism
              </a>
            </div>
          </div>
        )}
